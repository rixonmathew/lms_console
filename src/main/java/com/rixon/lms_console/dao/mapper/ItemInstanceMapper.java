...
public class ItemInstanceMapper {
    ...
    public static ItemInstanceRecord mapToItemInstanceRecord(ItemInstance itemInstance) {
    ...
    public static List<ItemInstancePropertyRecord> mapItemInstancePropertyRecords(
            Map<Property, PropertyValue> propertiesMap, ItemInstanceRecord itemInstanceRecord) {
