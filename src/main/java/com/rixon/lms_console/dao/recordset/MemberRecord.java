...
@Table(name="MEMBER")
@NamedQueries({
        @NamedQuery(name=MemberRecord.FIND_MEMBER,query = "select x from MemberRS x where x.emailId = :emailId and x.password = :password"),
        @NamedQuery(name=MemberRecord.ALL_MEMBERS,query = "select x from MemberRS x")
})
