...
CREATE SEQUENCE member_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
CREATE SEQUENCE member_property_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
...
CREATE SEQUENCE feature_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
CREATE SEQUENCE role_feature_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
...
CREATE SEQUENCE property_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
CREATE SEQUENCE item_property_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
CREATE SEQUENCE item_instance_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
CREATE SEQUENCE item_instance_property_id_seq
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
CREATE SEQUENCE ITEM_INSTANCE_TRANSACTION_ID_SEQ
  AS BIGINT
    START WITH 100
    INCREMENT BY 1;
